  ...
  const testimonials = [
    {
      ...
      content:
        "A IA Tradex revolucionou minha forma de investir. A velocidade de execução e as ferramentas de análise são incomparáveis no mercado brasileiro.",
      rating: 5,
    },
    {
      ...
      role: "Day Trader",
      content:
        "Depois de testar várias plataformas, a IA Tradex é definitivamente superior. O suporte ao cliente é excepcional e a interface é intuitiva mesmo para operações complexas.",
      rating: 5,
    },
    {
      ...
      content:
        "Recomendo a IA Tradex para todos os meus clientes. A segurança e a diversidade de ativos disponíveis tornam a plataforma ideal para qualquer perfil de investidor.",
      rating: 5,
    },
  ]
    ...
    <div className="flex min-h-screen flex-col bg-white dark:bg-gray-900">
      ...
      >
        <div className="flex items-center justify-between px-5 h-16">
          <Link href="/" className="flex items-center gap-2">
            <Image src="asafebroker/logomodelado_inverted.png" alt="IA Tradex" width={120} height={24} className="h-6 w-auto dark:hidden" />
          </Link>
          <motion.button
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex justify-between items-center mb-8">
              <Link href="/" className="flex items-center gap-2">
                <Image src="asafebroker/logomodelado_inverted.png" alt="IA Tradex" width={28} height={28} className="h-7 w-auto" />
              </Link>
              <motion.button
                className="p-2 text-gray-700 dark:text-gray-300 focus:outline-none rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Button variant="outline" className="group h-12 text-base" asChild>
                  <a href="https://t.me/IA TradexSupportBot?start=w38740082" target="_blank" rel="noopener noreferrer">
        ...
        <section id="cta" className="px-5 py-12 bg-blue-900 text-white">
          <div className="text-center">
            ...
            <p className="text-blue-100 mb-6">
              Junte-se a milhares de investidores que já estão transformando seu futuro financeiro com a IA Tradex.
            </p>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 px-5">
        <div className="flex items-center gap-2 mb-4">
          <Image src="applebroker/logo_sem_fundo.png" alt="IA Tradex" width={120} height={24} className="h-6 w-auto" />
        </div>
        ...
        <div className="border-t border-gray-800 pt-4 text-xs text-center">
          <p>© {new Date().getFullYear()} IA Tradex. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  )
