          ...
          <div className="container relative z-10 flex h-20 items-center justify-between">
            <div className="flex items-center gap-2">
              <Link href="/" className="flex items-center gap-2">
                <Image src="asafebroker/logomodelado_inverted.png" alt="IA Tradex" width={180} height={36} className="h-10 w-auto" />
              </Link>
            </div>
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex justify-between items-center mb-8">
                <Link href="/" className="flex items-center gap-2">
                  <Image src="asafebroker/logomodelado_inverted.png" alt="IA Tradex" width={120} height={24} className="h-6 w-auto" />
                </Link>
          ...
          <section ref={partnersRef} className="py-16 bg-gray-50 dark:bg-gray-900/50">
            <div className="container">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300">Invista nas maiores empresas do mundo com a IA Tradex</p>
              </motion.div>
          ...
          <section id="testimonials" ref={testimonialsRef} className="py-20 bg-white dark:bg-gray-900">
            <div className="container">
              ...
              >
                ...
                <motion.p className="text-lg text-gray-600 dark:text-gray-300" variants={fadeInUp}>
                  Milhares de investidores já transformaram sua experiência de investimento com a IA Tradex.
                </motion.p>
              </motion.div>
